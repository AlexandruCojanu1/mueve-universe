    ...
    case "whatsapp":
      return (
        <svg {...common} strokeLinecap="round" strokeLinejoin="round">
          <path d="M3 21l1.6-4.8A8 8 0 1 1 8 19.4z" />
          <path d="M8.5 8.5c-.3 0-.7.1-.9.5-.3.4-.9 1-.9 2.3s1 2.7 1.1 2.9c.1.2 1.9 3 4.7 4.1 2.3.9 2.8.7 3.3.7s1.5-.6 1.7-1.2c.2-.6.2-1.1.1-1.2-.1-.1-.3-.2-.6-.4l-1.6-.8c-.2-.1-.4-.1-.6.1l-.7.9c-.1.2-.3.2-.5.1-.7-.3-1.4-.6-2.1-1.4-.5-.6-.9-1.3-1-1.5-.1-.2 0-.4.1-.5l.4-.5c.1-.2.1-.3.2-.5 0-.2 0-.3 0-.5l-.7-1.6c-.2-.5-.4-.4-.6-.4z" fill="currentColor" stroke="none" />
        </svg>
      );
  }
}
